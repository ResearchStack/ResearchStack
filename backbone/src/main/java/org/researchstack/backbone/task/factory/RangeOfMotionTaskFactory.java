 ...
 *
 * This class was created to encapsulate the creation of Range of Motion (ROM) Tasks,
...
public class RangeOfMotionTaskFactory {
    ...
    protected static OrderedTask kneeRangeOfMotionTask(
            Context context,
            String identifier,
            String intendedUseDescription,
            TaskOptions.Side sideOptions,
