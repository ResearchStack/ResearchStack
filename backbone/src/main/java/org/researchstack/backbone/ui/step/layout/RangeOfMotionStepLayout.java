...
public class RangeOfMotionStepLayout extends ActiveStepLayout {
    ...
    public void onFinish() {
        ...
        //orientationEventListener.disable(); //can we call this without instantiating another class?
    ...
    protected void stepResultFinished() {
        ...
        if (sensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR) == null) {
            ...
            if (initial_orientation == ORIENTATION_REVERSE_LANDSCAPE) {
                ...
                minimum = start - getMaximumAngle(); //TODO landscape, portrait and reverse portrait
            }
        }
        ...
        if (sensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR) == null) {
            ...
            if (initial_orientation == ORIENTATION_REVERSE_LANDSCAPE) {
               ...
               maximum = start - getMinimumAngle(); // TODO landscape, portrait and reverse portrait
            }
        }
