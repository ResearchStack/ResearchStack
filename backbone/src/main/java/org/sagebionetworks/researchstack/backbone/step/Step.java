...
import org.sagebionetworks.researchstack.backbone.utils.ObjectUtils;

import java.io.Serializable;

/**
 * Step is the base class for the steps that can compose a task for presentation in an {@link
 * org.sagebionetworks.researchstack.backbone.ui.ViewTaskActivity} object. Each Step object represents one logical
 ...
 * paired with an {@link org.sagebionetworks.researchstack.backbone.ui.step.layout.StepLayout} subclass that
 * displays the step.
 * <p>
 * To use a step, instantiate an Step object and populate its properties. Add the step to a task,
 * such as an {@link org.sagebionetworks.researchstack.backbone.task.OrderedTask} object, and then present the task
...
public class Step implements Serializable {
     ...
     * (a {@link org.sagebionetworks.researchstack.backbone.result.StepResult} object) to the step that generated it
    ...
    /**
     * Returns the class that the {@link org.sagebionetworks.researchstack.backbone.ui.ViewTaskActivity} should
     ...
     *
     * @return the class of the {@link org.sagebionetworks.researchstack.backbone.ui.step.layout.StepLayout} for
     * this step
     */
     ...
     *
     * @param stepLayoutClass the {@link org.sagebionetworks.researchstack.backbone.ui.step.layout.StepLayout} class
