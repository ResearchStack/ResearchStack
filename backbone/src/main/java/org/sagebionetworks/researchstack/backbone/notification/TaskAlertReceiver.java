package org.sagebionetworks.researchstack.backbone.notification;
...
public class TaskAlertReceiver extends BroadcastReceiver {
    ...
    // Intent Actions
    //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
    public static final String ALERT_CREATE = "org.sagebionetworks.researchstack.backbone.notification.ALERT_CREATE";
    public static final String ALERT_CREATE_ALL = "org.sagebionetworks.researchstack.backbone.notification.ALERT_CREATE_ALL";
    public static final String ALERT_DELETE = "org.sagebionetworks.researchstack.backbone.notification.ALERT_DELETE";
    public static final String ALERT_DELETE_ALL = "org.sagebionetworks.researchstack.backbone.notification.ALERT_DELETE_ALL";
