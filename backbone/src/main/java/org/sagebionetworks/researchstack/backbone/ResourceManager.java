...
public abstract class ResourceManager extends ResourcePathManager {
    ...
    /**
     * Returns a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing the
     * StudyOverview file.
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing the
     * StudyOverview file.
     */
    public abstract Resource getStudyOverview();

    /**
     * Returns a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing an
     * HTML version of the Consent file.
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing an
     * HTML version of the Consent file.
     */
     ...
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing an PDF
     ...
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing an HTML
     ...
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing a
     * consent section file
     */
    public abstract Resource getConsentSections();

    /**
     * Returns a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing a
     * learn-sections file
     *
     * @return a {@link org.sagebionetworks.researchstack.backbone.ResourcePathManager.Resource} representing a
     * learn-sections file
