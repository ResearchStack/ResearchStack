...
import org.researchstack.skinsampleapp.BuildConfig;
import org.researchstack.skinsampleapp.bridge.body.ConsentSignatureBody;
import org.researchstack.skinsampleapp.bridge.body.EmailBody;
import org.researchstack.skinsampleapp.bridge.body.SharingOptionBody;
import org.researchstack.skinsampleapp.bridge.body.SignInBody;
import org.researchstack.skinsampleapp.bridge.body.SignUpBody;
import org.researchstack.skinsampleapp.bridge.body.SurveyAnswer;
import org.researchstack.skinsampleapp.bridge.body.WithdrawalBody;
...
public abstract class BridgeDataProvider extends DataProvider
{
    ...
    public SchedulesAndTasksModel loadTasksAndSchedules(Context context)
    {
        ...
        for(SchedulesAndTasksModel.ScheduleModel schedule : schedulesAndTasksModel.schedules)
        {
            ...
            else if(!TextUtils.isEmpty(schedule.scheduleString))
            {
