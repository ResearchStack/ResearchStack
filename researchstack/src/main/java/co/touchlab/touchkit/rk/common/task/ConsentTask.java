...
public class ConsentTask extends OrderedTask
{
    ...
    public ConsentTask(Context context)
    {
        ...
        ConsentSectionModel data = TouchKitApplication.getInstance().getConsentSectionsAndHtmlContent(context);
        ...
        signature.setRequiresSignatureImage(TouchKitApplication.getInstance().isSignatureEnabledInConsent());
