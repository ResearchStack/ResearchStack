...
public class PinCodeActivity2 extends AppCompatActivity implements StorageAccessListener {
    ...
    public void onDataAuth() {
        ...
        RxTextView.textChanges(pincode).map(CharSequence::toString).doOnNext(pin -> {
            if (summary.getCurrentTextColor() == errorColor) {
                summary.setTextColor(ThemeUtils.getTextColorPrimary(this));
            ...
            StorageAccess.getInstance().authenticate(this, pin);
            return true;
